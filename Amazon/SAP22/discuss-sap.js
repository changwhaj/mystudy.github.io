...
function setSequence(seq, vlist) {
    ...
    setCookie("SAP22"+seq, vlist, {secure: true, 'expires': expDate});
}
...
function NewTab(question_id, new_question_id, discuss_id) {
    ...
    if (cntrlIsPressed || seq == "X") {
        ...
        // if (discuss_id == "") {
            ...
            //     "/";
            url = "https://changwhaj.github.io/assets/exam/aws/SAP22/SAP-P" 
                + String(parseInt(question_id/10+0.9)) +
                ".html";
            url = "https://changwhaj.github.io/assets/exam/aws/SAP22/SAP-Q" + new_question_id + ".html"
        } else {
...
var passwd = getCookie('passsap22');
...
if (passwd == undefined) {
    ...
    if (passwd.toLowerCase() == PASSKEY) {
        ...
        expDate.setMonth(expDate.getMonth() + 1);
        expDate = expDate.toUTCString();
        setCookie('passsap22', passwd, {secure: true, 'expires': expDate});
    }
}
passwd = getCookie('passsap22');
